...
class CriteriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create criterium" do
    assert_difference('Criterium.count') do
      post criteria_url, params: { criterium: { cardinality: @criterium.cardinality, content: @criterium.content, item_id: @criterium.item_id, name: @criterium.name, status: @criterium.status } }
    end
  ...
  test "should update criterium" do
    patch criterium_url(@criterium), params: { criterium: { cardinality: @criterium.cardinality, content: @criterium.content, item_id: @criterium.item_id, name: @criterium.name, status: @criterium.status } }
